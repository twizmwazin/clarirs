...
impl_py_ast_common! {
    type: BV,
    inner_type: BitVecAst<'static>,
    cache: PY_BV_CACHE,
    simplify: |inner| inner.simplify_ext(true, true)?,
    make_annotated: make_bitvec_annotated,
    make_clear: make_bitvec,
    dynast_variant: BitVec,
    dynast_into: into_bitvec,
    canon_name: "BitVec",
    init_chain: Base => Bits => BV,
}
