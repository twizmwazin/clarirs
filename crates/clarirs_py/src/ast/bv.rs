...
impl BV {
    ...
    pub fn simplify<'py>(&self, py: Python<'py>, respect_annotations: bool) -> Result<Bound<'py, BV>, ClaripyError> {
        BV::new(py, &self.inner.simplify_with_respect_annotations(respect_annotations)?)
    }
