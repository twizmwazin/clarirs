...
create_exception!(claripy.errors, ClaripyZeroDivisionError, ClaripyOperationError);
create_exception!(claripy.errors, InvalidExtractBoundsError, ClaripyOperationError);
