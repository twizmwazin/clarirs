...
mod tests {
    ...
    fn test_unsigned_comparison() -> Result<(), BitVecError> {
        // Test basic ordering
        let bv1 = BitVec::from((5u8, 8));
        let bv2 = BitVec::from((10u8, 8));
        assert!(bv1 < bv2);
        assert!(bv1 <= bv2);
        assert!(bv2 > bv1);
        assert!(bv2 >= bv1);
        ...
        // Test equality
        let bv3 = BitVec::from((5u8, 8));
        assert!(bv1 == bv3);
        assert!(bv1 <= bv3);
        assert!(bv1 >= bv3);

        // Test with larger numbers
        let bv4 = BitVec::from((0xFFFFu16, 16));
        let bv5 = BitVec::from((0x0000u16, 16));
        assert!(bv4 > bv5);
        assert!(bv5 < bv4);
    ...
    fn test_signed_lt() -> Result<(), BitVecError> {
        ...
        let pos1 = BitVec::from((0x05u8, 8));
        let pos2 = BitVec::from((0x0Au8, 8));
        ...
        let neg5 = BitVec::from((0xFBu8, 8)); // -5
        let neg10 = BitVec::from((0xF6u8, 8)); // -10
        ...
        // Test equality
        let pos1_dup = BitVec::from((0x05u8, 8));
    ...
    fn test_signed_comparison_different_lengths() {
        let bv1 = BitVec::from((0x05u8, 8));
        let bv2 = BitVec::from((0x0005u16, 16));
        assert!(matches!(
            bv1.signed_lt(&bv2),
