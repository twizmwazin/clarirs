...
mod from_z3 {
    ...
    fn fp_neg() {
        ...
        let z3_neg = Z3_CONTEXT.with(|&z3_ctx| unsafe {
            wrap_ast(z3::Z3_mk_fpa_neg(z3_ctx, x.get_z3_ast())).unwrap()
        });
    ...
    fn fp_abs() {
        ...
        let z3_abs = Z3_CONTEXT.with(|&z3_ctx| unsafe {
            wrap_ast(z3::Z3_mk_fpa_abs(z3_ctx, x.get_z3_ast())).unwrap()
        });
