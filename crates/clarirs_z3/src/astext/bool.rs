...
pub(crate) fn to_z3(ast: &AstRef, children: &[RcAst]) -> Result<RcAst, ClarirsError> {
    Z3_CONTEXT.with(|&z3_ctx| unsafe {
        Ok(match ast.op() {
            ...
            .try_into()?,
            AstOp::Not(..) => unop!(z3_ctx, children, mk_not),
            AstOp::And(..) => {
            ...
            AstOp::Xor(..) => binop!(z3_ctx, children, mk_xor),
            AstOp::Eq(..) => {
                let a = child(children, 0)?;
                let b = child(children, 1)?;
                let sort = z3::get_sort(z3_ctx, **a);
                let sort_kind = z3::get_sort_kind(z3_ctx, sort);
                if sort_kind == z3::SortKind::FloatingPoint {
                    z3::mk_fpa_eq(z3_ctx, **a, **b).try_into()?
                } else {
                    z3::mk_eq(z3_ctx, **a, **b).try_into()?
                }
            }
            AstOp::Neq(..) => {
                let a = child(children, 0)?;
            ...
            z3::AstKind::App => {
                ...
                match decl_kind {
                    ...
                    z3::DeclKind::Not => {
                        ...
                        // Special case: if the inner expression is an Eq, convert to Neq
                    ...
                    z3::DeclKind::Eq => {
                        ...
                        match sort_kind {
                            z3::SortKind::Bool => {
                                let lhs = from_z3(ctx, arg0)?;
                                let rhs = from_z3(ctx, arg1)?;
                                ctx.eq_(lhs, rhs)
                            }
                            z3::SortKind::Bv => {
                                let lhs = super::bv::from_z3(ctx, arg0)?;
                                let rhs = super::bv::from_z3(ctx, arg1)?;
                                ctx.eq_(lhs, rhs)
                            }
                            z3::SortKind::FloatingPoint => {
                                let lhs = super::float::from_z3(ctx, arg0)?;
                                let rhs = super::float::from_z3(ctx, arg1)?;
                                ctx.eq_(lhs, rhs)
                            }
                            z3::SortKind::Seq => {
                                let lhs = super::string::from_z3(ctx, arg0)?;
                                let rhs = super::string::from_z3(ctx, arg1)?;
                                ctx.eq_(lhs, rhs)
                            }
                    ...
                    | z3::DeclKind::Sgeq => {
                        ...
                        let a = super::bv::from_z3(ctx, arg0)?;
                        let b = super::bv::from_z3(ctx, arg1)?;
                    ...
                    | z3::DeclKind::FpaGe => {
                        ...
                        let a = super::float::from_z3(ctx, arg0)?;
                        let b = super::float::from_z3(ctx, arg1)?;
                    ...
                    | z3::DeclKind::SeqSuffix => {
                        ...
                        let a = super::string::from_z3(ctx, arg0)?;
                        let b = super::string::from_z3(ctx, arg1)?;
