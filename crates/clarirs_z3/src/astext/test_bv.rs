...
mod from_z3 {
    ...
    fn and() {
        ...
        Z3_CONTEXT.with(|z3_ctx| unsafe {
            ...
            let y = mk_bv("y", 8);
            let z3_ast =
                wrap_ast(z3::Z3_mk_bvand(*z3_ctx, x.get_z3_ast(), y.get_z3_ast())).unwrap();
    ...
    fn xor() {
        ...
        Z3_CONTEXT.with(|z3_ctx| unsafe {
            ...
            let y = mk_bv("y", 8);
            let z3_ast =
                wrap_ast(z3::Z3_mk_bvxor(*z3_ctx, x.get_z3_ast(), y.get_z3_ast())).unwrap();
    ...
    fn add() {
        ...
        Z3_CONTEXT.with(|z3_ctx| unsafe {
            ...
            let y = mk_bv("y", 8);
            let z3_ast =
                wrap_ast(z3::Z3_mk_bvadd(*z3_ctx, x.get_z3_ast(), y.get_z3_ast())).unwrap();
    ...
    fn sub() {
        ...
        Z3_CONTEXT.with(|z3_ctx| unsafe {
            ...
            let y = mk_bv("y", 8);
            let z3_ast =
                wrap_ast(z3::Z3_mk_bvsub(*z3_ctx, x.get_z3_ast(), y.get_z3_ast())).unwrap();
    ...
    fn mul() {
        ...
        Z3_CONTEXT.with(|z3_ctx| unsafe {
            ...
            let y = mk_bv("y", 8);
            let z3_ast =
                wrap_ast(z3::Z3_mk_bvmul(*z3_ctx, x.get_z3_ast(), y.get_z3_ast())).unwrap();
    ...
    fn udiv() {
        ...
        Z3_CONTEXT.with(|z3_ctx| unsafe {
            ...
            let y = mk_bv("y", 8);
            let z3_ast =
                wrap_ast(z3::Z3_mk_bvudiv(*z3_ctx, x.get_z3_ast(), y.get_z3_ast())).unwrap();
    ...
    fn sdiv() {
        ...
        Z3_CONTEXT.with(|z3_ctx| unsafe {
            ...
            let y = mk_bv("y", 8);
            let z3_ast =
                wrap_ast(z3::Z3_mk_bvsdiv(*z3_ctx, x.get_z3_ast(), y.get_z3_ast())).unwrap();
    ...
    fn urem() {
        ...
        Z3_CONTEXT.with(|z3_ctx| unsafe {
            ...
            let y = mk_bv("y", 8);
            let z3_ast =
                wrap_ast(z3::Z3_mk_bvurem(*z3_ctx, x.get_z3_ast(), y.get_z3_ast())).unwrap();
    ...
    fn srem() {
        ...
        Z3_CONTEXT.with(|z3_ctx| unsafe {
            ...
            let y = mk_bv("y", 8);
            let z3_ast =
                wrap_ast(z3::Z3_mk_bvsrem(*z3_ctx, x.get_z3_ast(), y.get_z3_ast())).unwrap();
    ...
    fn shl() {
        ...
        Z3_CONTEXT.with(|z3_ctx| unsafe {
            ...
            let y = mk_bv("y", 8);
            let z3_ast =
                wrap_ast(z3::Z3_mk_bvshl(*z3_ctx, x.get_z3_ast(), y.get_z3_ast())).unwrap();
    ...
    fn lshr() {
        ...
        Z3_CONTEXT.with(|z3_ctx| unsafe {
            ...
            let y = mk_bv("y", 8);
            let z3_ast =
                wrap_ast(z3::Z3_mk_bvlshr(*z3_ctx, x.get_z3_ast(), y.get_z3_ast())).unwrap();
    ...
    fn ashr() {
        ...
        Z3_CONTEXT.with(|z3_ctx| unsafe {
            ...
            let y = mk_bv("y", 8);
            let z3_ast =
                wrap_ast(z3::Z3_mk_bvashr(*z3_ctx, x.get_z3_ast(), y.get_z3_ast())).unwrap();
    ...
    fn rotate_left() {
        ...
        Z3_CONTEXT.with(|z3_ctx| unsafe {
            let x = mk_bv("x", 8);
            let y = mk_bv("y", 8);
            let z3_ast = wrap_ast(z3::Z3_mk_ext_rotate_left(
                *z3_ctx,
                x.get_z3_ast(),
                y.get_z3_ast(),
            ))
    ...
    fn rotate_right() {
        ...
        Z3_CONTEXT.with(|z3_ctx| unsafe {
            let x = mk_bv("x", 8);
            let y = mk_bv("y", 8);
            let z3_ast = wrap_ast(z3::Z3_mk_ext_rotate_right(
                *z3_ctx,
                x.get_z3_ast(),
                y.get_z3_ast(),
            ))
    ...
    fn concat_2args() {
        ...
        Z3_CONTEXT.with(|z3_ctx| unsafe {
            ...
            let y = mk_bv("y", 8);
            let z3_ast =
                wrap_ast(z3::Z3_mk_concat(*z3_ctx, x.get_z3_ast(), y.get_z3_ast())).unwrap();
    ...
    fn ite() {
        ...
        Z3_CONTEXT.with(|z3_ctx| unsafe {
            ...
            let x = mk_bv("x", 8);
            let y = mk_bv("y", 8);
            let z3_ast = wrap_ast(z3::Z3_mk_ite(
                *z3_ctx,
                c.get_z3_ast(),
                x.get_z3_ast(),
                y.get_z3_ast(),
