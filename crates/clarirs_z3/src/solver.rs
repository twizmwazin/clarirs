...
mod tests {
    ...
    mod test_bitvec_optimize {
        ...
        fn test_min_unsigned_concrete() -> Result<(), ClarirsError> {
            ...
            let bv = ctx.bvv(BitVec::from(42u64))?;
        ...
        fn test_min_unsigned_constrained() -> Result<(), ClarirsError> {
            ...
            let lower_bound = ctx.bvv(BitVec::from(10u64))?;
            let upper_bound = ctx.bvv(BitVec::from(20u64))?;
        ...
        fn test_min_unsigned_complex() -> Result<(), ClarirsError> {
            ...
            let ten = ctx.bvv(BitVec::from(10u8))?;
            ...
            let six = ctx.bvv(BitVec::from(6u8))?;
        ...
        fn test_max_unsigned_complex() -> Result<(), ClarirsError> {
            ...
            let hundred = ctx.bvv(BitVec::from(100u8))?;
            let twenty = ctx.bvv(BitVec::from(20u8))?;
            ...
            let ninety_nine = ctx.bvv(BitVec::from(99u8))?;
        ...
        fn test_min_signed_constrained() -> Result<(), ClarirsError> {
            ...
            let lower_bound = ctx.bvv(BitVec::from(0xfffffffffffffff6u64))?;
            let upper_bound = ctx.bvv(BitVec::from(20u64))?;
        ...
        fn test_min_signed_complex() -> Result<(), ClarirsError> {
            ...
            let neg_five = ctx.bvv(BitVec::from(0xfbu8))?;
            let ten = ctx.bvv(BitVec::from(10u8))?;
            ...
            let neg_four = ctx.bvv(BitVec::from(0xfcu8))?;
        ...
        fn test_max_signed_complex() -> Result<(), ClarirsError> {
            ...
            let neg_twenty = ctx.bvv(BitVec::from(0xecu8))?;
        ...
        fn test_min_signed_negative_range() -> Result<(), ClarirsError> {
            ...
            let lower_bound = ctx.bvv(BitVec::from(0x9cu8))?;
            let upper_bound = ctx.bvv(BitVec::from(0xf6u8))?;
    ...
    fn test_unsat_core_minimal() -> Result<(), ClarirsError> {
        ...
        // Add constraints
        let c0 = ctx.ugt(&x, &ctx.bvv(BitVec::from(10u8))?)?; // x > 10
        let c1 = ctx.ult(&x, &ctx.bvv(BitVec::from(5u8))?)?; // x < 5 - contradicts c0
        let c2 = ctx.ugt(&x, &ctx.bvv(BitVec::from(0u8))?)?; // x > 0 - doesn't contribute to unsat
